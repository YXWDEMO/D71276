...
//上电
#define    Disp_Power_Rest         { Dispinfo.Disp_Task = PowerOnReset;   Dispinfo.Disp_Smok_Error_Flag = 1; Dispinfo.Disp_Ic_Rgb_Digi_Syn_Flag = 0;    			sysinit();Set_Disp_Num(1,0,400,DISP_ALL,0x00);}
//低电
#define    Disp_Bat_Low            { Dispinfo.Disp_Task = LowVol;         Dispinfo.Disp_Smok_Error_Flag = 1; Dispinfo.Disp_Ic_Rgb_Digi_Syn_Flag = 1;Smg_Paoma_En_stop=0;Dispinfo.Smg_Paoma_Time_stop=0;Smg_Paoma_En = 0;Set_Disp_Num(1,0,500,0x00,0x00);}  
//高阻
#define    Disp_High               { Dispinfo.Disp_Task = HighRes;        Dispinfo.Disp_Smok_Error_Flag = 1; Dispinfo.Disp_Ic_Rgb_Digi_Syn_Flag = 1;     			sysinit();Set_Disp_Num(4,0,25,OutInfo.Oil_Data_Map|BatInfo.Bat_Leve_Data,0x00);}  
//短路
#define    Disp_Short              { Dispinfo.Disp_Task = LowRes;        Dispinfo.Disp_Smok_Error_Flag = 1; Dispinfo.Disp_Ic_Rgb_Digi_Syn_Flag = 0;Smg_Paoma_En_stop=0;Dispinfo.Smg_Paoma_Time_stop=0;Dispinfo.Disp_cl_bat=0; 			sysinit();Set_Disp_Num(5,25,50,0x00,0x00);}  
//超时
#define    Disp_SmokOver           { Dispinfo.Disp_Task = OverTime;    		Dispinfo.Disp_Smok_Error_Flag = 1;   Dispinfo.Disp_Ic_Rgb_Digi_Syn_Flag = 1;  Smg_Paoma_En_stop=0;Dispinfo.Smg_Paoma_Time_stop=0;Smg_Paoma_En = 0;Dispinfo.Disp_cl_bat=0;  			sysinit();Set_Disp_Num(2,25,50,0x00,0x00);}    

//OVP保护
#define    Disp_Ovp_EN             { Dispinfo.Disp_Task = Dis_Ovp;        Dispinfo.Disp_Smok_Error_Flag = 1;  Dispinfo.Disp_Ic_Rgb_Digi_Syn_Flag = 0;   			sysinit(); Set_Disp_Num(1,0,1000,0x00,0x00);}

//首次插入USB
#define    Disp_Power_Usb_In       { Dispinfo.Disp_Task = UsbFirstIn;     Dispinfo.Disp_Smok_Error_Flag = 0;  Dispinfo.Disp_Ic_Rgb_Digi_Syn_Flag = 0;    			sysinit();Set_Disp_Num(1,0,200,DISP_ALL,0x00);}    


//USB拔出
#define    Disp_Usb_Out            { Dispinfo.Disp_Task = UsbOut;         Dispinfo.Disp_Smok_Error_Flag = 0;  Dispinfo.Disp_Ic_Rgb_Digi_Syn_Flag = 0;    			sysinit();Set_Disp_Num(3,25,50,0x00,0x00);}    
