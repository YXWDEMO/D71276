...
#define    MOS_PIN               LL_GPIO_PIN_7

#define    Dis_Ic_PORT              GPIOC
#define    Dis_Ic_PIN               LL_GPIO_PIN_0

#define    HEAT_PORT             GPIOB
#define    HEAT_PIN              LL_GPIO_PIN_1

#define    MOS1_PORT              GPIOA
#define    MOS1_PIN               LL_GPIO_PIN_6
...
#define    HEAT1_PIN              LL_GPIO_PIN_0
	...
	#define    KEY_PIN               LL_GPIO_PIN_2
#endif

/**********************SWITCH DIP**************************/
// #define		 SWITCH_DIP_PORT		 GPIOA
// #define		 SWITCH_DIP_PIN		 	 LL_GPIO_PIN_1

// #define		 SWITCH1_DIP_PORT		 GPIOA
// #define		 SWITCH1_DIP_PIN		 LL_GPIO_PIN_3

/********************** USB ******************************/
#define    USB_PORT              GPIOA
#define    USB_PIN               LL_GPIO_PIN_3

#define    CHRG_PORT             GPIOA
#define    CHRG_PIN              LL_GPIO_PIN_4

#define    CHRG_EN_PORT          GPIOA
#define    CHRG_EN_PIN           LL_GPIO_PIN_5

// 充电使能控制
#define    CHRG_ENABLE            LL_GPIO_SetPinMode(CHRG_EN_PORT,CHRG_EN_PIN,LL_GPIO_MODE_INPUT);
#define    CHRG_DISABLE           LL_GPIO_SetPinMode(CHRG_EN_PORT,CHRG_EN_PIN,LL_GPIO_MODE_OUTPUT);LL_GPIO_SetOutputPin(CHRG_EN_PORT,CHRG_EN_PIN);
...
//#define    SWITCH1_IO          LL_GPIO_IsInputPinSet(SWITCH1_DIP_PORT,SWITCH1_DIP_PIN)



#define   MOS_ON               {LL_GPIO_ResetOutputPin(MOS_PORT,MOS_PIN);  }
#define   MOS_OFF              {LL_GPIO_SetOutputPin(MOS_PORT,MOS_PIN);    }
#define   Dis_Ic_ON            {LL_GPIO_ResetOutputPin(Dis_Ic_PORT,Dis_Ic_PIN);  }
#define   Dis_Ic_OFF           {LL_GPIO_SetOutputPin(Dis_Ic_PORT,Dis_Ic_PIN);    }
