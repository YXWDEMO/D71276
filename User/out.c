...
// 	 if(Out_Oil_Time <= 38000) // 760s = 38000/5
// 	 {
// 			Oil_Leve = 5;
// 	 }else if(Out_Oil_Time <= 76000) // 1520s
// 	 {
// 			Oil_Leve = 4;
// 	 }else if(Out_Oil_Time <= 114000) // 2280s
// 	 {
// 			Oil_Leve = 3;
// 	 }else if(Out_Oil_Time <= 152000) // 3040s
// 	 {
// 			Oil_Leve = 2;
// 	 }else if(Out_Oil_Time <= 190000) // 3800s
// 	 {
// 			Oil_Leve = 1;
// 	 }else
// 	 {
	...
	if(OUTSTART)
{
		...
		if(!Dispinfo.Disp_Num&&SysInfo.systemState != SYSTEM_OFF)
		{
